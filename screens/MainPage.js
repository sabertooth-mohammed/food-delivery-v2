...
import {View, Text, ScrollView, SafeAreaView, StyleSheet, TextInput, Image, useWindowDimensions, FlatList} from 'react-native'
            ...
            <View style = {{flex: 1, alignItems: "center"}}>
                ...
                <ScrollView showsVerticalScrollIndicator = {false} contentContainerStyle = {{width: 0.9*width, alignItems: "center"}}>
                    <View style = {{width: 0.9*width, ...styles.header}}>
                        ...
                        <Image style = {{alignSelf: "center"}} source = {require("../assets/img/fintech.png")} />
